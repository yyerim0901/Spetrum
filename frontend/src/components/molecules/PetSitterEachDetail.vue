    ...
    <div class="detail-box">
      ...
      <div style="width: 420px; padding:5px;">
        ...
        <span v-if="board.data.user.userId == this.userid">
          <i
            class="fas fa-edit"
            style="margin:5px 0 0 10px; float:right;"
            @click="moveChangePetSitter"
          ></i>
          <i
            class="fas fa-trash"
            style="margin:5px 0 0 10px; float:right;"
        ...
        <div>
          <p @click="chatting()" style="width: 420px; text-align:right;">
            작성일자 : {{ board.data.created.substr(0, 10)
            }}<span style="color:#FFDDE1;"> | </span>작성자 : {{ board.data.user.userId }}
          </p>
      ...
      <div v-html="this.content"
        style="text-align:start; border:solid; padding:20px 0px;
        border-width:1px 0; border-color:#E5EAEF; width: 420px; height: 300px;"
      >
      </div>
      ...
      <div style="margin-bottom:50px;">
        ...
        <StyledButton btype="realsmall" bcolor="babypink" @click="createComment()"
          >작성</StyledButton
        >
      </div>
    </div>
